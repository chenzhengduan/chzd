...
这里是本地 Markdown 知识库的网页入口，当前包含销售流程、短视频拍摄、社交平台账号运营与电商运营知识：

<div class="kb-switch">
  <a class="kb-switch-card" href="sales-customer-conversion/">
    <span class="kb-switch-title">销售流程与客户转化</span>
    <span class="kb-switch-desc">从线索分级、需求确认和报价，到跟单交付、售后复购与制造业行业案例。</span>
  </a>
  <a class="kb-switch-card" href="short-video-shooting/">
    <span class="kb-switch-title">短视频拍摄实操</span>
    <span class="kb-switch-desc">从手机入门、镜头与光线，到美妆包装、瓶器和生产线行业实战。</span>
  </a>
  <a class="kb-switch-card" href="social-platform-operations/">
    <span class="kb-switch-title">社交平台账号运营</span>
    <span class="kb-switch-desc">抖音、小红书、TikTok、Instagram、Facebook、YouTube、X 等平台的真实门槛、冷启动与合规规则。</span>
  </a>
